...
void RenderingSystem::Update()
{
	...
	{
		shader->SetUniform("u_toggle", 1);
		AnimationShader->SetUniform("u_toggle", 1);

	}
	if (glfwGetKey(BackEnd::m_Window, GLFW_KEY_2) == GLFW_PRESS)
	{
		shader->SetUniform("u_toggle", 2);
		AnimationShader->SetUniform("u_toggle",2);
	}
	if (glfwGetKey(BackEnd::m_Window, GLFW_KEY_3) == GLFW_PRESS)
	{
		shader->SetUniform("u_toggle", 3);
		AnimationShader->SetUniform("u_toggle", 3);
	}
	if (glfwGetKey(BackEnd::m_Window, GLFW_KEY_4) == GLFW_PRESS)
	{
		shader->SetUniform("u_toggle", 4);
		AnimationShader->SetUniform("u_toggle", 4);
	}
